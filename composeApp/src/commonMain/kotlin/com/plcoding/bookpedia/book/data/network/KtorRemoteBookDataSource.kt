    ...
    override suspend fun searchBooks(
        ...
        return safeCall<SearchResponseDto> {
            httpClient.get(
                ...
                parameter("fields", "key,title,author_name,author_key,cover_edition_key,cover_i,ratings_average,ratings_count," +
                        "first_publish_year,language,number_of_pages_median,edition_count")
            }
        }
    }
